...
describe("Module extremely-simple-server", function () {
    describe("create", function () {
        ...
        it("http://127.0.0.1:8080/evil.exe should return a status 404", function (done) {
        ...
        it("http://127.0.0.1:8080/amd should return a status 200", function (done) {
        ...
        it("http://127.0.0.1:4343/amd should return a status 200", function (done) {
            XServer.create(4343);
